...
# -*- coding: utf-8 -*-
#
# enpassreaderlib documentation build configuration file, created by
# sphinx-quickstart
#
...
sphinx.ext.apidoc.main(argv=['-f', '-o', os.path.join(project_root, 'docs'),
                             os.path.join(project_root, '''enpassreaderlib''')])
...
version = enpassreaderlib.__version__
# The full version, including alpha/beta/rc tags.
release = enpassreaderlib.__version__
...
htmlhelp_basename = '''enpassreaderlibdoc'''
...
# [howto/manual]).
latex_documents = [
    ('index', '''enpassreaderlib.tex''',
     u'''enpassreaderlib Documentation''',
