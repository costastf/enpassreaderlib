...
setup(
    ...
    version=version,
    description='''A library implementing the decrypting and retrieving secrets from an enpass 6 database.''',
    long_description=readme + '\n\n' + history,
    author='''Costas Tyfoxylos''',
    author_email='''costas.tyf@gmail.com''',
    url='''https://github.com/costastf/enpassreaderlib''',
    packages=find_packages(where='.', exclude=('tests', 'hooks', '_CI*')),
    package_dir={'''enpassreaderlib''':
                 '''enpassreaderlib'''},
